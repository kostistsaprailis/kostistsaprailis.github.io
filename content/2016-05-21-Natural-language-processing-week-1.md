...
Category: NLP
Tags: NLP, Coursera
Slug: Natural-language-processing-week-1
Authors: Kostis Tsaprailis
Summary: My notes on the Natural Language Processing Coursera course for the first week. Just some compressed notes.
---
...
![Levenshtein Distance](/img/levenshtein-distance.png)
...
![Smith-Waterman algorithm](/img/smith-waterman.png)
